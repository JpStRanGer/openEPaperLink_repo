...
- **`config.sh`** (gitignored) — per-user file with `ap="..."`, an associative array of named tags, and an optional `default_tag`. Generated by the interactive setup; never commit.
...
declare -A tags=(
  [min]=0000032E45CB3E15
  [kollega]=0000032DA56D3E14
)
default_tag="min"
```
